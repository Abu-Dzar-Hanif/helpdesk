...
import 'package:helpdesk/view/EditTeknisi.dart';
import 'package:helpdesk/view/TambahTeknisi.dart';
...
class _DataTeknisiState extends State<DataTeknisi> {
  ...
  Future<void> _lihatData() async {
    ...
    if (response.contentLength == 2) {
      ...
      data.forEach((api) {
        final ab = new TeknisiModel(api['id_teknisi'], api['nama_teknisi'],
            api['gender'], api['vendor'], api['no_telpon']);
        list.add(ab);
      });
      setState(() {
        loading = false;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("No telp : " + x.no_telpon.toString(),
                                    style: TextStyle(
                                      fontSize: 15.0,
                                    )),
                              ],
